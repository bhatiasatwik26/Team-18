 ...
 * @property {string} time - The time of the schedule item
 * @property {string} title - The title of the schedule item
 * @property {string} description - The description of the schedule item
 */

/**
 * @typedef {Object} EventScheduleProps
 * @property {string} title - The title of the event schedule
 * @property {string} subtitle - The subtitle of the event schedule
 * @property {ScheduleItem[]} scheduleItems - The schedule items
 */

/**
 * @param {EventScheduleProps} props
 */
const EventSchedule = ({
  title,
  subtitle,
